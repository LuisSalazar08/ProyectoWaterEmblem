...
public enum Armas 
{
	...
	//Lanzas
	IronLance(TipoArma.Lanza,1,8,7,80,0,360,NoEffect.INSTANCE),//7
	...
	//Hachas
	IronAxe(TipoArma.Hacha,1,10,8,75,0,270,NoEffect.INSTANCE),//14
	...
	//Arcos
	IronBow(TipoArma.Arco,2,5,6,85,0,540,NoEffect.INSTANCE),//23
	...
	//Grimorios
	Fire(TipoArma.Grimorio,2,4,5,90,0,560,NoEffect.INSTANCE),//28
	...
	Excalibur(TipoArma.Grimorio,2,13,18,90,10,0,NonSellableEffect.INSTANCE);//33
